...
def add_margin(image: Image.Image, margin_size: int, color: str) -> Image.Image:
    ''' Adds a margin to the left and right of the image. '''
    width, height = image.size
    new_width = width + 2 * margin_size
    new_image = Image.new("RGB", (new_width, height), color)
